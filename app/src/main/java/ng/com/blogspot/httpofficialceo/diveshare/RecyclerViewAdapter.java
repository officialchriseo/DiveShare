...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof ViewHolder) {
            ...
            genericViewHolder.itemTxtTitle.setText(model.getContactName());
            genericViewHolder.itemTxtMessage.setText(model.getContactNumber());
//            genericViewHolder.imgUser.setImageResource(Integer.parseInt(model.getContactImage()));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(final View itemView) {
            ...
            this.mContactCheckbox = (CheckBox) itemView.findViewById(R.id.contact_checkbox);
